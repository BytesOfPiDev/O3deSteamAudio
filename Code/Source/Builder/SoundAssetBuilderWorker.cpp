...
{
    static constexpr auto BuildRawAssetKey{ "Build Raw SaSoundAsset" };
        ...
        AssetBuilderSDK::CreateJobsResponse& response) const
    {
        ...
        AZStd::ranges::for_each(
            ...
            [&response, &request](auto const& info)
            {
                ...
                {
                    descriptor.m_jobKey = BuildRawAssetKey;
                }
    ...
    {
        if (AZ::StringFunc::Equal(request.m_jobDescription.m_jobKey, BuildRawAssetKey))
        {
