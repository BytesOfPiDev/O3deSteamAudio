...
namespace SteamAudio
{
    AZ_TYPE_INFO_WITH_NAME_IMPL(
        SteamAudioModuleInterface, "SteamAudioModuleInterface", SteamAudioModuleInterfaceTypeId);
    ...
    {
        return AZ::ComponentTypeList{ azrtti_typeid<SteamAudioSystemComponent>() };
    }
} // namespace SteamAudio
