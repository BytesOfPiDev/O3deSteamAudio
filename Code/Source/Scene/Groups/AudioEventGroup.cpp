...
{
    char const* const LoggingGroup::s_disabledOption = "No audio event";

    LoggingGroup::LoggingGroup() = default;
    ...
    void LoggingGroup::Reflect(AZ::ReflectContext* context)
    {
        ...
        serializeContext->Class<LoggingGroup, AZ::SceneAPI::DataTypes::IManifestObject>()
            ->Version(1)
        ...
        if (editContext)
        {
            editContext->Class<LoggingGroup>("Logger", "Add additional logging to the SceneAPI.")
                ...
                ->DataElement(
                    AZ::Edit::UIHandlers::Default,
                    &LoggingGroup::m_logProcessingEvents,
                    "Log processing events",
                    "Log processing events as they happen.");
        }
    }

    void LoggingGroup::SetName(AZStd::string const& name)
    {
        m_groupName = name;
    }
    ...
    AZStd::string const& LoggingGroup::GetName() const
    {
        return m_groupName;
    }
    ...
    auto LoggingGroup::GetRuleContainer() -> AZ::SceneAPI::Containers::RuleContainer&
    {
        return m_ruleContainer;
    }

    auto LoggingGroup::GetRuleContainerConst() const
        -> const AZ::SceneAPI::Containers::RuleContainer&
    {
        return m_ruleContainer;
    }

    auto LoggingGroup::GetGraphLogRoot() const -> AZStd::string const&
    {
        return m_graphLogRoot;
    }

    auto LoggingGroup::DoesLogGraph() const -> bool
    {
        return m_graphLogRoot.compare(s_disabledOption) != 0;
    }

    auto LoggingGroup::DoesLogProcessingEvents() const -> bool
    {
