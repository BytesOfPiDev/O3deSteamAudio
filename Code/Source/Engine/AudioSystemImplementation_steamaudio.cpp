...
namespace SteamAudio
{
    ...
    void AudioSystemImpl_steamaudio::SetPaths()
    {
        ...
        {
            AZLOG_INFO(
                "No BopAudio configuration file found at key: \"%s\".", Settings::LanguageKey);
        };
    ...
    auto AudioSystemImpl_steamaudio::ResetAudioObject(
        Audio::IATLAudioObjectData* const audioObjectData) -> Audio::EAudioRequestStatus
    {
        AZLOG(LOG_asi_steamaudio, "BopAudio: ResetAudioObject.\n");
    ...
    auto AudioSystemImpl_steamaudio::CreateAudioSource(
