...
namespace SteamAudio
{
    ...
    public:
        ...
        AZ_TYPE_INFO_WITH_NAME_DECL(AudioSystemImpl_steamaudio);
        AUDIO_IMPL_CLASS_ALLOCATOR(AudioSystemImpl_steamaudio);
        AZ_DISABLE_COPY_MOVE(AudioSystemImpl_steamaudio);
